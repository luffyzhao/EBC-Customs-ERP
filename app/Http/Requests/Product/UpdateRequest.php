...
class UpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'sku' => ['required', 'min:1', 'max:64', Rule::unique('products', 'sku')->where('company_id', $this->input('company_id'))->ignore($this->route('product'))],
            'barcode' => ['required', 'min:1', 'max:64', Rule::unique('products', 'barcode')->where('company_id', $this->input('company_id'))->ignore($this->route('product'))],
