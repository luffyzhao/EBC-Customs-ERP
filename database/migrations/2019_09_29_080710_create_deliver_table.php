...
class CreateDeliverTable extends Migration
{
    ...
    public function up()
    {
        ...
        DB::statement("ALTER TABLE `delivers` comment '物流表'");

        Schema::create('deliver_warehouses', function (Blueprint $table){
            $table->unsignedBigInteger('deliver_id');
            $table->unsignedBigInteger('warehouse_id');
            $table->string('code', 100)->comment('仓库物流代码');
        });
        DB::statement("ALTER TABLE `deliver_warehouses` comment '物流仓库对应表'");
    }
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('deliver_warehouses');
    }
}
